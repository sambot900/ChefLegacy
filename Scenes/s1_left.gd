...
@onready var raw_patty_1 = $raw_patty_1
@onready var raw_patty_2 = $raw_patty_2
@onready var cooked_patty_1 = $cooked_patty_1
@onready var cooked_patty_2 = $cooked_patty_2
@onready var burnt_patty_1 = $burnt_patty_1
@onready var burnt_patty_2 = $burnt_patty_2
